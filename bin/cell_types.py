...
class CellTypesTab(object):
    ...
    def __init__(self):
        ...
        name_btn.style.button_color = 'tan'
        self.chemotaxis_substrate1 = Text(value='signal', disabled=False, style=style, layout=widget_layout_long)
        ...
        name_btn = Button(description='substrate', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.text0 = Text(value='signal', disabled=False, style=style, layout=widget_layout_long)
...
#      ================== <custom_data>, if present ==================
        ...
        name_btn = Button(description='max_attachments', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        self.float39 = FloatText(value='2', step='0.1', style=style, layout=widget_layout)
        ...
        name_btn = Button(description='head', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        ...
        name_btn = Button(description='head_initial', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'lightgreen'
        ...
        name_btn = Button(description='transfer_rate', disabled=True, layout=name_button_layout)
        name_btn.style.button_color = 'tan'
        self.float42 = FloatText(value='0.1', step='0.01', style=style, layout=widget_layout)
        units_btn = Button(description='1/min', disabled=True, layout=name_button_layout)
        units_btn.style.button_color = 'tan'
        description_btn = Button(description='', disabled=True, layout=desc_button_layout)
        description_btn.style.button_color = 'tan'
